...
This project is a light-weight version of [**Postman**](https://www.postman.com/) in one app for using (and building) APIs. It supports method selection, URL, headers.
...
![Auth Page](src/assets/screenshots/rest-client_auth.png)

![Client Page](src/assets/screenshots/rest-client.png)

![History Page](src/assets/screenshots/rest-client_history.png)
