...
describe("Header (compact)", () => {
  it("Guest user: displays Sign In and Sign Up links", () => {
    render(<Header />);
  ...
  it("Sign out (success): calls Firebase signOut, pushes to home, sets signedOutRef, shows success toast, and DELETEs /api/session", async () => {
  ...
  it("changing locale triggers router.replace with the selected locale", () => {
    render(<Header />);
